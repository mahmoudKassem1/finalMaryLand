...
const sendEmail = async (options) => {
  ...
  // If 'html' is provided (e.g. Order Details), use it directly.
  // If 'message' is provided (e.g. Password Reset), wrap it in a text paragraph.
  let contentBody = '';
  ...
  // Button Logic (Only renders if ctaUrl is present)
  ...
  const mailOptions = {
    ...
    to: options.email || options.to, // ✅ Fix: Supports both 'email' and 'to'
